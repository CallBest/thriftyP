...
// set the header menu
$body->set_template("templates/delivery/header.html");
echo $body->create();
...
switch($page){
  case 'search':
  $body->set_template("templates/delivery/clientinfo.html");
    break;
  default:
    $body->set_template("templates/delivery/main.html");
}
echo $body->create();

// set the footer, if any.
$body->set_template("templates/delivery/footer.html");
echo $body->create();